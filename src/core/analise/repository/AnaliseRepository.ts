...
export default interface AnaliseRepository {
    ...
    updateAnalise(id: string, nomeAnalise: string, especificacao: string, dataDeAnalise: string, status: string, amostra: string, amostraId: string, resultado: string) : Promise<Analise>
}